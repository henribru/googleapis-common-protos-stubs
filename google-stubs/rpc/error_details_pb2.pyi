...
class QuotaFailure(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        violations: (
            collections.abc.Iterable[global___QuotaFailure.Violation] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
...
class PreconditionFailure(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        violations: (
            collections.abc.Iterable[global___PreconditionFailure.Violation] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["violations", b"violations"]
...
class BadRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        field_violations: (
            collections.abc.Iterable[global___BadRequest.FieldViolation] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
